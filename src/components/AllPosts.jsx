...
import { default as EditIcon, default as SearchIcon } from '@mui/icons-material/Edit';
  ...
  navigate("/edit",{state:{id}});
    ...
    useEffect(() => {
      const fetchPosts = async () => {
        const response = await axios.get(`http://localhost:8081/JobPosts/keyword/${query}`);    
      ...
      const handleDelete = (id) => {
        async function deletePost() {
          await axios.delete(`http://localhost:8081/JobPost/${postId}`);
      }
      deletePost();
